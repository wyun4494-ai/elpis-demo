...
-- 基本参数（8个）
('PARAM001', '屏幕尺寸', 'input', NULL, '基本参数', 1, 1),
('PARAM002', '网络类型', 'select', '["2G", "3G", "4G", "5G", "全网通"]', '基本参数', 2, 1),
('PARAM003', '操作系统', 'select', '["Android", "iOS", "HarmonyOS", "Windows", "其他"]', '基本参数', 3, 1),
('PARAM004', '电池容量', 'input', NULL, '基本参数', 4, 1),
('PARAM005', '材质', 'input', NULL, '基本参数', 5, 1),
('PARAM006', '产地', 'input', NULL, '基本参数', 6, 1),
('PARAM007', '保修期', 'select', '["1年", "2年", "3年", "终身保修"]', '基本参数', 7, 1),
('PARAM008', '重量', 'input', NULL, '基本参数', 8, 1),

-- 服装参数（7个）
('PARAM101', '使用季节', 'checkbox', '["春", "夏", "秋", "冬"]', '服装参数', 1, 1),
('PARAM102', '适用人群', 'select', '["男士", "女士", "儿童", "中性", "情侣"]', '服装参数', 2, 1),
('PARAM103', '袖长', 'select', '["长袖", "短袖", "七分袖", "五分袖", "无袖"]', '服装参数', 3, 1),
('PARAM104', '领型', 'select', '["圆领", "V领", "翻领", "立领", "一字领", "高领"]', '服装参数', 4, 1),
('PARAM105', '版型', 'select', '["修身", "宽松", "标准", "oversize"]', '服装参数', 5, 1),
('PARAM106', '厚度', 'select', '["薄款", "常规", "加厚", "羽绒"]', '服装参数', 6, 1),
('PARAM107', '弹性', 'select', '["无弹", "微弹", "高弹"]', '服装参数', 7, 1),

-- 数码参数（7个）
('PARAM201', '处理器', 'input', NULL, '数码参数', 1, 1),
('PARAM202', '运行内存', 'select', '["2GB", "4GB", "6GB", "8GB", "12GB", "16GB", "18GB"]', '数码参数', 2, 1),
('PARAM203', '存储容量', 'select', '["16GB", "32GB", "64GB", "128GB", "256GB", "512GB", "1TB"]', '数码参数', 3, 1),
('PARAM204', '屏幕刷新率', 'select', '["60Hz", "90Hz", "120Hz", "144Hz", "165Hz"]', '数码参数', 4, 1),
('PARAM205', '摄像头像素', 'input', NULL, '数码参数', 5, 1),
('PARAM206', '充电功率', 'input', NULL, '数码参数', 6, 1),
('PARAM207', '防水等级', 'select', '["IP54", "IP67", "IP68", "无"]', '数码参数', 7, 1),

-- 家电参数（5个）
('PARAM301', '能效等级', 'select', '["一级", "二级", "三级", "四级", "五级"]', '家电参数', 1, 1),
('PARAM302', '功率', 'input', NULL, '家电参数', 2, 1),
('PARAM303', '容量', 'input', NULL, '家电参数', 3, 1),
('PARAM304', '噪音', 'input', NULL, '家电参数', 4, 1),
('PARAM305', '控制方式', 'checkbox', '["手动", "遥控", "APP控制", "语音控制"]', '家电参数', 5, 1),

-- 通用参数（3个）
('PARAM401', '品牌认证', 'checkbox', '["3C认证", "CE认证", "FCC认证", "ROHS认证"]', '通用参数', 1, 1),
('PARAM402', '包装清单', 'input', NULL, '通用参数', 2, 1),
('PARAM403', '售后服务', 'input', NULL, '通用参数', 3, 1);
...
-- 查看数据统计
SELECT '分类' AS 类型, COUNT(*) AS 数量 FROM t_product_category
UNION ALL
SELECT '品牌', COUNT(*) FROM t_product_brand
UNION ALL
